...
try:
    ...
    Prisma = Client
    # Might be considered unsafe. Just trying.
    sig = utils.fn_signature(Client.__init__)
    utils.monkeypatch(Prisma, "__repr__", f"Prisma({sig})")
    # class Prisma(Client):
    #     def __init__(
    #         self,
    #          "*,
    ...
    #         datasource: Optional[types.DatasourceOverride] = None,
    #         connect_timeout: int = 10,
    #         http: Optional[types.HttpConfig] = None,
    #     ) -> None:
    #         super().__init__(
