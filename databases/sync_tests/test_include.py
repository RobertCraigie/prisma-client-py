...
def posts_fixture(client: Prisma, user_id: str) -> List[Post]:
    return create_or_get_posts(client, user_id)


def create_or_get_posts(client: Prisma, user_id: str) -> List[Post]:
