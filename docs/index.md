...
Unlike other Python ORMs, Prisma Client Python is **fully type safe** and offers native support for usage **with and without** `async`. All you have to do is [specify the type of client](/setup/) you would like to use for your project in the [Prisma schema file](#the-prisma-schema).

Core features:

- [Full type safety](/type-safety/)
- [With / without async](/setup/)
- [Recursive and pseudo-recursive types](/config/#recursive-type-depth)
- [Atomic updates](/reference/common/#updating-atomic-fields)
- [Complex cross-relational queries](/reference/common/#filtering-by-relational-fields)
- [Partial type generation](/partial-types/)
- [Batching write queries](/reference/batching/)
...
This section provides a high-level overview of how Prisma works and its most important technical components. For a more thorough introduction, visit the [documentation](docs).
...
In this example we'll install the dependencies required for an asynchronous client, if you would like to use a synchronous client see [setting up a synchronous client](/setup/#synchronous-client).
...
For a more complete list of queries you can perform with Prisma Client Python see the [documentation](/reference/common/).
...
For more details see the [documentation](/type-safety/).
...
See the [contributing documentation](/contributing/contributing/) for more information.
